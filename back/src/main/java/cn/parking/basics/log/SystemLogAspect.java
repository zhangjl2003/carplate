...
import cn.parking.basics.utils.IpInfoUtil;
import cn.parking.basics.utils.ThreadPoolUtil;
import cn.parking.data.entity.Log;
import cn.parking.data.service.LogService;
...
public class SystemLogAspect {
    ...
    @Pointcut("@annotation(cn.parking.basics.log.SystemLog)")
