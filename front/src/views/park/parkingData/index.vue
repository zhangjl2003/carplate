        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    ...
                    <Form-item label="" prop="owner">
                        <Input type="text" v-model="searchForm.owner" placeholder="车主姓名" clearable style="width: 150px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getParkingDataList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
