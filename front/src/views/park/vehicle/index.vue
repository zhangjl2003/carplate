        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    ...
                    <Form-item label="" prop="carType">
                        <Select v-model="searchForm.carType" placeholder="车辆类型" clearable style="width: 150px">
                    ...
                    <Form-item label="" prop="ownerName">
                        <Input type="text" v-model="searchForm.ownerName" placeholder="车主姓名" clearable style="width: 150px" />
                    </Form-item>
