...
<div class="search">
            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="carNumber">
                        <Input type="text" v-model="searchForm.carNumber" placeholder="IC卡号" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="workUser">
                        <Input type="text" v-model="searchForm.workUser" placeholder="开卡经办人" clearable style="width: 150px" />
                    </Form-item>
    ...
    <Modal v-model="reModal" title="工卡充值" draggable :mask="false" footer-hide width="800">
        <Form :label-width="100" label-position="left">
            <Row>
                <Col span="24">
                <FormItem label="充值金额">
                    <InputNumber v-model="reNumber" min="0" max="5000000" placeholder="请输入充值金额..." style="width:100%"></InputNumber>
                </FormItem>
                </Col>
                <Col span="24">
                <Divider>
                    <Button @click="rechargeIcCardFx" :loading="reLoading" type="success">确认充值</Button>
                </Divider>
                </Col>
            </Row>
        </Form>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getIcCardList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
