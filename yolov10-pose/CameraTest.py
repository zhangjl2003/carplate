...
mode = 0
def insert_parking_info(car_number, fee_id):
    ...
    if success:
        ...
        if len(location_list) >= 1:
            ...
            for each in license_imgs:
                ...
                if license_num:
                    ...
                    if '-' in license_num:
                        ...
                        license_name = license_num
                    # 将识别出的车牌号添加到结果列表中
                    lisence_res.append(license_name)
                    # 将识别置信度添加到置信度列表中
                    conf_list.append(conf)

                    if license_name in plate_count:
                        plate_count[license_name] += 1
                    else:
                        plate_count[license_name] = 1
            ...
            if frame_counter == 20:
                ...
                if mode == 1:
                    insert_parking_info(most_common_plate, "a")
                else:
                    departure_(most_common_plate, "a")
